 ...
 * @author sistems
 */
public class frmModuloInventario extends javax.swing.JFrame {

    /**
     * Creates new form frmModuloInventario
     */
    public frmModuloInventario() {
    ...
    private void initComponents() {
        ...
        jPanel1.add(rbProducto, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 360, -1, -1));
        ...
        jPanel1.add(comboProducto, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 150, 350, 20));
        ...
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 190, 90, 20));
        jPanel1.add(spinnerPrecioUnidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 190, 340, -1));
        ...
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 230, 90, 20));
        jPanel1.add(spinnerPrecioMayoreo, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 230, 340, -1));
        ...
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 180, 80, 30));

        jSeparator6.setForeground(new java.awt.Color(51, 153, 255));
        jPanel1.add(jSeparator6, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 200, 350, 10));

        txtLote.setBorder(null);
        jPanel1.add(txtLote, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 180, 350, 20));

        jLabel15.setBackground(new java.awt.Color(255, 102, 0));
        jLabel15.setFont(new java.awt.Font("Ebrima", 0, 14)); // NOI18N
        jLabel15.setText("Fecha");
        jPanel1.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 220, 40, 30));

        jLabel16.setBackground(new java.awt.Color(255, 102, 0));
        jLabel16.setFont(new java.awt.Font("Ebrima", 0, 14)); // NOI18N
        jLabel16.setText("Cantidad");
        jPanel1.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 110, 60, 20));
        jPanel1.add(spinnerCantidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 110, 340, -1));
        jPanel1.add(comboFecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 230, 350, -1));
        ...
        jPanel1.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 150, 90, 20));
        jPanel1.add(spinnerCosto, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 150, 340, -1));
        ...
        jPanel1.add(jSeparator7, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 120, 340, 10));

        txtId.setBorder(null);
        jPanel1.add(txtId, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 100, 340, 20));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmModuloInventario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmModuloInventario().setVisible(true);
            }
        });
    }

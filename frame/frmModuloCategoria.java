 ...
 * @author sistems
 */
public class frmModuloCategoria extends javax.swing.JFrame {

    /**
     * Creates new form frmModuloCategoria
     */
    public frmModuloCategoria() {
    ...
    private void initComponents() {
        ...
        btnCerrar.setBounds(1020, 0, 30, 30);
        ...
        btnMinimizar.setBounds(990, 0, 30, 30);
        ...
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 140, 120, 30));

        jLabel8.setBackground(new java.awt.Color(240, 86, 52));
        jLabel8.setFont(new java.awt.Font("Ebrima", 0, 14)); // NOI18N
        jLabel8.setText("Estado");
        jLabel8.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 190, 50, 30));

        jSeparator4.setForeground(new java.awt.Color(51, 153, 255));
        jPanel1.add(jSeparator4, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 160, 380, 10));

        txtNombreCategoria.setBorder(null);
        jPanel1.add(txtNombreCategoria, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 140, 380, 20));

        ComboEstado.setEditable(true);
        ComboEstado.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Activo", "Inactivo" }));
        ComboEstado.setBorder(null);
        jPanel1.add(ComboEstado, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 200, 380, 20));
        ...
        rbId.setText("ID");
        jPanel1.add(rbId, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 360, -1, -1));

        rbCategoria.setBackground(new java.awt.Color(255, 255, 255));
        rbCategoria.setSelected(true);
        rbCategoria.setText("Categoria");
        jPanel1.add(rbCategoria, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 360, -1, -1));

        txtBuscar.setBorder(null);
        jPanel1.add(txtBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 360, 180, 20));

        jSeparator3.setForeground(new java.awt.Color(51, 153, 255));
        jPanel1.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 380, 180, 10));
        ...
        jPanel1.add(jButton10, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 350, 30, 30));
        ...
        jPanel1.add(btnAgregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 290, 130, 40));
        ...
        jPanel1.add(btnActualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 290, 130, 40));
        ...
        jPanel1.add(btnEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 290, 130, 40));
        ...
        jPanel1.add(btnReporte, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 290, 130, 40));

        jLabel6.setBackground(new java.awt.Color(255, 102, 0));
        jLabel6.setFont(new java.awt.Font("Ebrima", 0, 14)); // NOI18N
        jLabel6.setText("Id");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 100, 40, 30));

        jSeparator5.setForeground(new java.awt.Color(51, 153, 255));
        jPanel1.add(jSeparator5, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 120, 380, 10));

        txtId.setBorder(null);
        jPanel1.add(txtId, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 100, 380, 20));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmModuloCategoria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmModuloCategoria().setVisible(true);
            }
        });
    }

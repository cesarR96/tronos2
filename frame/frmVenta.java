...
public class frmVenta extends javax.swing.JFrame {
    ...
    public frmVenta() {
        ...
        AWTUtilities.setWindowShape(this, forma);
         ...
         panelCarritoVenta.setVisible(false);//ocultar panel
    ...
    private void initComponents() {
        ...
        panelCarritoVenta = new javax.swing.JPanel();
        ...
        jPanel1.add(txtNumeroVenta, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 100, 190, 20));

        jSeparator3.setForeground(new java.awt.Color(0, 0, 0));
        jPanel1.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 120, 190, 10));
        ...
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 100, 70, 30));
        ...
        jPanel1.add(jSeparator4, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 160, 190, 10));

        txtCodigoBarra.setBorder(null);
        jPanel1.add(txtCodigoBarra, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 140, 190, 20));
        ...
        panelCarritoVenta.setBackground(new java.awt.Color(248, 249, 249));
        panelCarritoVenta.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        ...
        panelCarritoVenta.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 970, 90));

        lbTotal.setBackground(new java.awt.Color(255, 102, 0));
        lbTotal.setFont(new java.awt.Font("Ebrima", 1, 18)); // NOI18N
        lbTotal.setForeground(new java.awt.Color(51, 153, 255));
        lbTotal.setText("0.0");
        panelCarritoVenta.add(lbTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 140, 70, 30));

        jLabel11.setBackground(new java.awt.Color(255, 102, 0));
        jLabel11.setFont(new java.awt.Font("Ebrima", 1, 18)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(51, 153, 255));
        jLabel11.setText("CARRITO DE VENTA");
        panelCarritoVenta.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 200, 30));
        ...
        panelCarritoVenta.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 140, 70, 30));

        btnAgregarVenta.setBackground(new java.awt.Color(0, 255, 0));
        btnAgregarVenta.setForeground(new java.awt.Color(0, 51, 204));
        btnAgregarVenta.setText("AGREGAR VENTA");
        btnAgregarVenta.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(0, 51, 204)));
        ...
        panelCarritoVenta.add(btnAgregarVenta, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 220, 260, 30));

        jPanel1.add(panelCarritoVenta, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 240, 1000, 260));
        ...
        jPanel1.add(dateFecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 110, 180, -1));
    ...
    private void btnAgregarCarritoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarCarritoActionPerformed
        ...
        panelCarritoVenta.setVisible(true);//ocultar panel
    ...
    private javax.swing.JPanel panelCarritoVenta;

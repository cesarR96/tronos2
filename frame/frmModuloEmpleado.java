 ...
 * @author sistems
 */
public class frmModuloEmpleado extends javax.swing.JFrame {

    /**
     * Creates new form frmModuloEmpleado
     */
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtDui, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 140, 380, 20));

        jSeparator3.setForeground(new java.awt.Color(51, 153, 255));
        jPanel1.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 160, 380, 10));
        ...
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 140, 80, 30));

        jLabel8.setBackground(new java.awt.Color(240, 86, 52));
        jLabel8.setFont(new java.awt.Font("Ebrima", 0, 14)); // NOI18N
        jLabel8.setText("Estado");
        jLabel8.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 220, 50, 30));

        jSeparator4.setForeground(new java.awt.Color(51, 153, 255));
        jPanel1.add(jSeparator4, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 200, 380, 10));

        txtEmpleado.setBorder(null);
        jPanel1.add(txtEmpleado, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 180, 380, 20));

        jSeparator5.setForeground(new java.awt.Color(51, 153, 255));
        jPanel1.add(jSeparator5, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 240, 380, 10));

        txtCorreo.setBorder(null);
        jPanel1.add(txtCorreo, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 220, 380, 20));

        jSeparator6.setForeground(new java.awt.Color(51, 153, 255));
        jPanel1.add(jSeparator6, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 160, 380, 10));

        txtTelefono.setBorder(null);
        jPanel1.add(txtTelefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 140, 380, 20));

        txtDireccion.setBorder(null);
        jPanel1.add(txtDireccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 180, 380, 20));

        jLabel12.setBackground(new java.awt.Color(240, 86, 52));
        jLabel12.setFont(new java.awt.Font("Ebrima", 0, 14)); // NOI18N
        jLabel12.setText("Direccion ");
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 180, 80, 30));

        ComboEstado.setEditable(true);
        ComboEstado.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Activo", "Inactivo" }));
        ComboEstado.setBorder(null);
        jPanel1.add(ComboEstado, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 230, 380, 20));

        jSeparator9.setForeground(new java.awt.Color(51, 153, 255));
        jPanel1.add(jSeparator9, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 200, 380, 10));
        ...
        jPanel1.add(rbNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 360, -1, -1));

        rbEmpleado.setBackground(new java.awt.Color(255, 255, 255));
        rbEmpleado.setText("Nombre");
        jPanel1.add(rbEmpleado, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 360, -1, -1));
        ...
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 100, 80, 30));

        jSeparator7.setForeground(new java.awt.Color(51, 153, 255));
        jPanel1.add(jSeparator7, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 120, 380, 10));

        txtSueldo.setBorder(null);
        jPanel1.add(txtSueldo, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 100, 380, 20));

        jLabel10.setBackground(new java.awt.Color(255, 102, 0));
        jLabel10.setFont(new java.awt.Font("Ebrima", 0, 14)); // NOI18N
        jLabel10.setText("Id");
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 100, 40, 30));

        jSeparator10.setForeground(new java.awt.Color(51, 153, 255));
        jPanel1.add(jSeparator10, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 120, 380, 10));

        txtId.setBorder(null);
        jPanel1.add(txtId, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 100, 380, 20));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmModuloEmpleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmModuloEmpleado().setVisible(true);
            }
        });
    }
